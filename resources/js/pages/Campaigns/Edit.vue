...
const form = useForm({
    game_system_id: props.campaign.game_system_id as string | null,
    title: props.campaign.title,
    synopsis: props.campaign.description ?? '',
    frequency: props.campaign.frequency as string | null,
    schedule_notes: '',
    min_players: 3,
    max_players: props.campaign.max_players ?? 5,
    table_format: 'in_person',
    location: '',
    online_url: '',
    language: 'es',
    experience_level: null as string | null,
    character_creation: null as string | null,
    genres: [] as string[],
...
function submit(): void {
    form.put(`/campanas/mis-campanas/${props.campaign.id}/editar`, {
        preserveScroll: true,
        onError: () => {
            nextTick(() => {
...
<template>
    <DefaultLayout>
        ...
        <main class="mx-auto max-w-4xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div v-if="!props.campaign.can_edit" class="mb-6 rounded-lg border border-warning/30 bg-warning-bg p-4">
                <div class="flex">
                    ...
                    <div class="ml-3">
                        <p class="text-sm text-warning">
                            {{ t('campaigns.edit.notEditable') }}
                        </p>
                        <p v-if="props.campaign.frontend_creation_status_label" class="mt-1 text-sm text-warning/80">
                            {{ t('campaigns.edit.currentStatus', { status: props.campaign.frontend_creation_status_label }) }}
                        </p>
                    </div>
                </div>
            </div>
            ...
            <!-- Moderation notes -->
            <div v-if="props.campaign.moderation_notes" class="mb-6 rounded-lg border border-info/30 bg-info-bg p-4">
                <div class="flex">
                    <div class="flex-shrink-0">
                    ...
                    <div class="ml-3">
                        <h3 class="text-sm font-medium text-info">
                            {{ t('campaigns.edit.moderationNotes') }}
                        </h3>
                        <p class="mt-1 text-sm text-info/80">
                            {{ props.campaign.moderation_notes }}
                        </p>
                    </div>
                </div>
            </div>
            ...
            <form @submit.prevent="submit">
                            ...
                            <div class="space-y-6 p-6">
                                ...
                                <div>
                                    ...
                                    <FormCombobox
                                        ...
                                        :disabled="!props.campaign.can_edit"
                                        class="mt-1"
                                    />
                ...
                <div class="mt-6 flex items-center justify-end gap-4">
                    <BaseButton
                        type="submit"
                        variant="primary"
                        :disabled="form.processing || !props.campaign.can_edit"
